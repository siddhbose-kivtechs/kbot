...
function SendMsgBot(msg) {
  ...
  elementCPT.innerHTML =
    '<img src="ai-generated-7770511.avif" alt="K"> <span>K</span>';
  ContentChat.appendChild(elementCPT);
  ...
  setTimeout(() => {
    ...
    if (result == "" || result == undefined) {
      for (i of listScan["about"]) {
        if (i == msg || i + "?" == msg || i + "!" == msg) {
          result = `<img src="" alt="about raybot"></img><div class="bot-response text" text-first="true">${listMSG["about"][0]}</div><div class="bot-response text" text-last="true">${listMSG["about"][1]}</div>`;
        }
      }
    }
...

{
  ...
  elementCPT.classList.add("captionBot", "msgCaption");
  elementCPT.innerHTML =
    '<img src="ai-generated-7770511.avif" alt="KATLON Bot"> <span>K Bot</span>';
  ContentChat.appendChild(elementCPT);
  elementCPT.scrollIntoView();
